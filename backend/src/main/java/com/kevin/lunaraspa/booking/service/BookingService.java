...
public interface BookingService {
    ...
    RescheduleBookingResponse rescheduleByManager(Long bookingId, RescheduleBookingRequest request,
                                                  String currentUserEmail);

    EmailDispatchResponse resendBookingEmail(Long bookingId, String currentUserEmail);
}
